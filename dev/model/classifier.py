...
class _TNet(nn.Module):
    ...
    def __init__(self, in_dim, config, out_dim):
        ...
        # it in Classifier's feature alignment T-Net
...
class Classifier(nn.Module):
    ...
    value (logit representing signal non-normalized probability).
    ...
    def __init__(self, config):
        ...
        # Return raw logit instead of e.g. sigmoid output because
